...
namespace MyRoslynPackage.Codefixes
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(MyRoslynPackageCodeFixProvider)), Shared]
    public class MyRoslynPackageCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds
        {
            get { return ImmutableArray.Create(MyRoslynPackageAnalyzer.DiagnosticId); }
        }
